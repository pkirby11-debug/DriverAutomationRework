@{
    ...
    Description       = 'Automates downloading, packaging, and distributing Dell and Lenovo drivers and BIOS updates for SCCM/ConfigMgr environments. 1.9 adds Update-DATApplicationCommands to repair install commands on existing DAT apps, attaches DAT-standard CustomReturnCodes (2/3/4/5/6/256) to new deployment types so vendor exit codes stop tripping SCCM''s failure path, and hardens the BIOS flash ExitCode capture for PS 5.1 / CCMExec.'
