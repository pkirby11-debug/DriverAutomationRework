@{
    ...
    Description       = 'Automates downloading, packaging, and distributing Dell and Lenovo drivers and BIOS updates for SCCM/ConfigMgr environments. 1.9.1 collapses Update-DATApplicationCommands''s install-command rebuild and return-code attach into a single SDM round-trip / one revision bump, halving CI-metadata churn that caused 0x87D00314 (CI Version Info timed out) on large fleets during the 1.9.0 retrofit.'
