@{
    ...
    Description       = '2.46.4 - Auto-repairs Dell catalog anomalies where driver packages were published with Model name="-", prevents "-" appearing in GUI model list or freezing builds, and matches native Win11 packs via SystemID map.'
